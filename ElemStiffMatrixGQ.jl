# Arquivo: ElemStiffMatrixGQ.jl
module ElemStiffMatrixGQModule

export ElemStiffMatrixGQ

function ElemStiffMatrixGQ(str, n, elem)
                        ...
                        dxPhi =
                            (1 / (64 * a)) * [
                                -(
                                    (-1 + x2) *
                                    (-1 + x3) *
                                    (-19 - 18 * x1 + 27 * x1^2 + 9 * x2^2 + 9 * x3^2)
                                ),
                        ...
                        dyPhi =
                            (1 / (64 * b)) * [
                                -(
                                    (-1 + x1) *
                                    (-1 + x3) *
                                    (-19 + 9 * x1^2 - 18 * x2 + 27 * x2^2 + 9 * x3^2)
                                ),
                                9 * (-1 + x1) * (-3 - 2 * x2 + 9 * x2^2) * (-1 + x3),
                                -9 * (-1 + x1) * (-3 + 2 * x2 + 9 * x2^2) * (-1 + x3),
                                (-1 + x1) *
                                (-1 + x3) *
                                (-19 + 9 * x1^2 + 18 * x2 + 27 * x2^2 + 9 * x3^2),
                        ...
                        dzPhi =
                            (1 / (64 * c)) * [
                                -(
                                    (-1 + x1) *
                                    (-1 + x2) *
                                    (-19 + 9 * x1^2 + 9 * x2^2 - 18 * x3 + 27 * x3^2)
                                ),
