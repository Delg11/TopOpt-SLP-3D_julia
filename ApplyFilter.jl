...
module ApplyFilterModule

export ApplyFilter

function ApplyFilter(x, W, w, opfilter, trans)
    # ApplyFilter applies the filter to the density elements.
    # INPUT: 
    # x - vector with the original density elements.
    ...
    # OUTPUT: 
    # xfil - vector with the filtered density elements.
    # ----------
