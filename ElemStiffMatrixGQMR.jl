# Arquivo: ElemStiffMatrixGQMR.jl
module ElemStiffMatrixGQMRModule

export ElemStiffMatrixGQMR

function ElemStiffMatrixGQMR(str, n, elem)
    ...
    k = fill(nothing, n^3)  # Inicializa k como um vetor de células vazio
    kv = zeros((3 * m)^2, n^3)  # Matriz com as integrais de rigidez
    ...
    CenterPt = collect(-1+(1/n):(2/n):(1-(1/n)))  # Usar collect para gerar um vetor
    ...
    for elz = 1:n
        for elx = 1:n
            for ely = 1:n
                k2 = zeros(3 * m, 3 * m)  # Inicializando a matriz k2
                        ...
                        for g2 = 1:n2
                            ...
                            elseif elem.deg == 2
                                if elem.type == 1  # Lagrange quadratic element
                                    dxPhi =
                                        (1 / (8 * a)) * [
                                            (-1 + 2 * x1) * (-x2 + x2^2) * (-x3 + x3^2),
                                            2 * (-1 + 2 * x1) * (1 - x2^2) * (-x3 + x3^2),
                                            (-1 + 2 * x1) * (x2 + x2^2) * (-x3 + x3^2),
                                            -4 * x1 * (-x2 + x2^2) * (-x3 + x3^2),
                                            -8 * x1 * (1 - x2^2) * (-x3 + x3^2),
                                            -4 * x1 * (x2 + x2^2) * (-x3 + x3^2),
                                            (1 + 2 * x1) * (-x2 + x2^2) * (-x3 + x3^2),
                                            2 * (1 + 2 * x1) * (1 - x2^2) * (-x3 + x3^2),
                                            (1 + 2 * x1) * (x2 + x2^2) * (-x3 + x3^2),
                                            2 * (-1 + 2 * x1) * (-x2 + x2^2) * (1 - x3^2),
                                            4 * (-1 + 2 * x1) * (1 - x2^2) * (1 - x3^2),
                                            2 * (-1 + 2 * x1) * (x2 + x2^2) * (1 - x3^2),
                                            -8 * x1 * (-x2 + x2^2) * (1 - x3^2),
                                            -16 * x1 * (1 - x2^2) * (1 - x3^2),
                                            -8 * x1 * (x2 + x2^2) * (1 - x3^2),
                                    ...
                                    dyPhi =
                                        (1 / (8 * b)) * [
                                            (-x1 + x1^2) * (-1 + 2 * x2) * (-x3 + x3^2),
                                            -4 * (-x1 + x1^2) * x2 * (-x3 + x3^2),
                                            (-x1 + x1^2) * (1 + 2 * x2) * (-x3 + x3^2),
                                            2 * (1 - x1^2) * (-1 + 2 * x2) * (-x3 + x3^2),
                                            -8 * (1 - x1^2) * x2 * (-x3 + x3^2),
                                            2 * (1 - x1^2) * (1 + 2 * x2) * (-x3 + x3^2),
                                            (x1 + x1^2) * (-1 + 2 * x2) * (-x3 + x3^2),
                                            -4 * (x1 + x1^2) * x2 * (-x3 + x3^2),
                                            (x1 + x1^2) * (1 + 2 * x2) * (-x3 + x3^2),
                                            2 * (-x1 + x1^2) * (-1 + 2 * x2) * (1 - x3^2),
                                            -8 * (-x1 + x1^2) * x2 * (1 - x3^2),
                                            2 * (-x1 + x1^2) * (1 + 2 * x2) * (1 - x3^2),
                                            4 * (1 - x1^2) * (-1 + 2 * x2) * (1 - x3^2),
                                            -16 * (1 - x1^2) * x2 * (1 - x3^2),
                                            4 * (1 - x1^2) * (1 + 2 * x2) * (1 - x3^2),
                                            2 * (x1 + x1^2) * (-1 + 2 * x2) * (1 - x3^2),
                                            -8 * (x1 + x1^2) * x2 * (1 - x3^2),
                                    ...
                                    dzPhi =
                                        (1 / (8 * c)) * [
                                            (-x1 + x1^2) * (-x2 + x2^2) * (-1 + 2 * x3),
                                            2 * (-x1 + x1^2) * (1 - x2^2) * (-1 + 2 * x3),
                                            (-x1 + x1^2) * (x2 + x2^2) * (-1 + 2 * x3),
                                            2 * (1 - x1^2) * (-x2 + x2^2) * (-1 + 2 * x3),
                                            4 * (1 - x1^2) * (1 - x2^2) * (-1 + 2 * x3),
                                            2 * (1 - x1^2) * (x2 + x2^2) * (-1 + 2 * x3),
                                            (x1 + x1^2) * (-x2 + x2^2) * (-1 + 2 * x3),
                                            2 * (x1 + x1^2) * (1 - x2^2) * (-1 + 2 * x3),
                                            (x1 + x1^2) * (x2 + x2^2) * (-1 + 2 * x3),
                                            -4 * (-x1 + x1^2) * (-x2 + x2^2) * x3,
                                            -8 * (-x1 + x1^2) * (1 - x2^2) * x3,
                                            -4 * (-x1 + x1^2) * (x2 + x2^2) * x3,
                                            -8 * (1 - x1^2) * (-x2 + x2^2) * x3,
                                            -16 * (1 - x1^2) * (1 - x2^2) * x3,
                                ...
                                elseif (elem.type == 2) # Serendipity quadratic element
                                    dxPhi =
                                        (1 / (8 * a)) * [
                                            (-1 + x2) * (-1 + x3) * (1 + 2 * x1 + x2 + x3),
                                            -2 * (-1 + x2^2) * (-1 + x3),
                                            (1 + x2) * (-1 - 2 * x1 + x2 - x3) * (-1 + x3),
                                            -4 * x1 * (-1 + x2) * (-1 + x3),
                                            4 * x1 * (1 + x2) * (-1 + x3),
                                            -(
                                                (-1 + x2) *
                                    ...
                                    dzPhi =
                                        (1 / (64 * c)) * [
                                            -(
                                                ...
                                                (-1 + x2) *
                                                (
                                                    -19 + 9 * x1^2 + 9 * x2^2 - 18 * x3 +
                                                    27 * x3^2
                                                )
                                            ),
                                            9 * (-1 + x1) * (1 - 3 * x2 - x2^2 + 3 * x2^3),
                                            -9 *
                                            (-1 + x1) *
                                            (-1 - 3 * x2 + x2^2 + 3 * x2^3),
                                            (-1 + x1) *
